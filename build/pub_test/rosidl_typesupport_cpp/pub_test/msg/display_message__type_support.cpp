...
static const _DisplayMessage_type_support_symbol_names_t _DisplayMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pub_test, msg, DisplayMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pub_test, msg, DisplayMessage)),
  }
};
...
{
  return &::pub_test::msg::rosidl_typesupport_cpp::DisplayMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pub_test, msg, DisplayMessage)() {
  return get_message_type_support_handle<pub_test::msg::DisplayMessage>();
}
